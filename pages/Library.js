  ...
  return (
    <>
      ...
      <section className={styles.container}>
        <h2 data-aos="fade-up">{t("conference_&_training")}</h2>
        <span className="myHr" />
        ...
        <div className={styles.row}>
          ...
          <div className={styles.card2} data-aos="fade-left">
            <Carousel>
              <div>
        ...
        <h3 data-aos="flip-up">{t("video_title")}</h3>
        <video controls data-aos="fade-up">
          <source src="/videos/conference_1.mp4" type="video/mp4" />
        </video>
        <h3 data-aos="flip-up">{t("video3_title")}</h3>
        <video poster="/videos/thumbnail_mili.png" controls data-aos="fade-up">
          <source src="/videos/DOC MILLI.mp4" type="video/mp4" />
        </video>
      </section>
      <section className={styles.container}>
        <h2 style={{ marginTop: "60px" }} data-aos="fade-up">
          {t("media_shows")}
        </h2>
        <span className="myHr" />
        <h3 data-aos="flip-up">{t("video2_title")}</h3>
        <video controls data-aos="fade-up">
          <source src="/videos/tv_show1.mp4" type="video/mp4" />
        </video>
        <h3 data-aos="flip-up">{t("tv_shows")}</h3>
        <div className={styles.rowImg}>
          <div className={styles.cardImg} data-aos="flip-right">
            <img src="/images/Library/passages/1.jpg" alt="show1" />
          </div>
          <div className={styles.cardImg} data-aos="flip-left">
